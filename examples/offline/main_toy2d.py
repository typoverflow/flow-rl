...
# Import plotting functions from plot_toy2d
...
class Trainer():
    ...
    def plot_and_eval(self, step: int, stage: str):
        ...
        # Let the agent plot its own custom visualizations and return metrics
        agent_metrics = self.agent.plot_toy2d(savedir, self.cfg.task)
...
@hydra.main(config_path="./config/toy2d", config_name="config", version_base=None)
def main(cfg: Config):
