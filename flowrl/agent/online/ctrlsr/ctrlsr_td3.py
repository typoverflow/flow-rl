...
from flowrl.config.online.mujoco.algo.ctrlsr.ctrlsr_td3 import CtrlSRTD3Config
...
class CtrlSRTD3Agent(TD3Agent):
    """
    CTRL-SR with Twin Delayed Deep Deterministic Policy Gradient (TD3) agent.
    """

    name = "CtrlSRTD3Agent"
    model_names = ["nce", "nce_target", "actor", "actor_target", "critic", "critic_target"]

    def __init__(self, obs_dim: int, act_dim: int, cfg: CtrlSRTD3Config, seed: int):
